    ...
    <div className="scroll-smooth bg-black h-dvh w-fit">
        ...
        <div className="bg-black h-screen grid grid-cols-2"><ScrollEffect> 
          <div className="ml-4 mt-[200px] flex justify-center items-center bg-gradient-to-r from-indigo-400 via-purple-800 to-pink-300 bg-clip-text text-transparent">
            <p className="font-bold text-6xl ml-6 ">
              Dive into infinite possiblities for your college exams preparation.
            </p>
          </div></ScrollEffect><ScrollEffect> 
          <div className="h-full w-full mt-6 items-center ml-auto mr-0">
        ...
        <div className="bg-black min-h-screen flex items-center justify-center p-10"><ScrollEffect>
          <div className="h-[550px] w-[1230px]">
            <AnimatedDiv />
          </div></ScrollEffect>
        </div>
        ...
        <div className="bg-black h-screen grid grid-cols-2"><ScrollEffect>
          <div className="h-[90%] mb-4 w-full mt-4 mr-auto rounded-lg">
          <AnimatedoneD side={"r"} />
